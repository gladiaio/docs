[Gladia's webapp](https://app.gladia.io/playground/1) is a convenient way to test our Speech To Text API. On the webapp
...
<Steps>
  ...
  <Step title="Select features">
    ...
    <Note>
      Only a few features of Gladia API are available on the webapp. For more advanced testing,

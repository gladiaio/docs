...
| **Starter** | 3 weeks | Yes — minimum **24 hours** |
| **Growth** | 3 weeks | Yes — minimum **24 hours** |
| **Enterprise** | 3 weeks | Yes — including zero data retention |

<Info>
Custom retention periods are available on **Starter**, **Growth**, and **Enterprise**. Zero data retention is available on **Enterprise** only. Contact [support](https://www.gladia.io/contact) to configure a custom retention period.
</Info>

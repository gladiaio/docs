...
- **Channels**: Pre-recorded jobs support up to **2 channels** (mono or stereo). Live sessions support up to **8 channels**, and the `channels` value must be set in the [init request](/api-reference/v2/live/init). See [Multiple channels](/chapters/limits-and-specifications/multiple-channels).

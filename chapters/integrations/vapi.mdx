...
## Quickstart (configure Gladia as Vapi transcriber)
    ...
    <video autoPlay muted loop playsInline className='w-full aspect-video rounded-xl' src='/assets/videos/recording.mp4'></video>
...
<CardGroup cols={3}> 
    <Card title="Get your API key" href="https://app.gladia.io/apikeys" icon="key"> Get your API key on the Gladia dashboard </Card>
    <Card title="Start your Vapi project" icon="headset" href="https://dashboard.vapi.ai" > And start transcribing with Gladia </Card> 
    <Card title="Configure Gladia in Vapi" icon="book" href="https://docs.vapi.ai/providers/transcriber/gladia" > Follow Vapi’s Gladia transcriber guide </Card> 
</CardGroup>
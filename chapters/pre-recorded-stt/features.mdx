...
You can enable enhanced punctuation processing to improve the accuracy and naturalness of punctuation in the transcription. This feature is currently in Alpha.

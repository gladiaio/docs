---
title: "Pre-recorded - Migration guide from V1 to V2"
sidebarTitle: "Pre-recorded - V1 to V2"
description: "Migrate to the latest version of Gladia's pre-recorded speech-to-text API"
---

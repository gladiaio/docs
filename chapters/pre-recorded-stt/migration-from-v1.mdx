...
<Steps>
  <Step title="Upload your file">
    ...
    More information about this step [in the API Reference](/api-reference/api-v2/Upload/post-v2upload)
  ...
  <Step title="Transcribe">
    ...
    More information about this step [in the API Reference](/api-reference/api-v2/Transcription/post-v2transcription)

...
<Tip>
When enabling both `sentences` and `translation`, you'll receive sentences output for the the original transcript, and **also** each `translation` result will contain the sentences output in the translated language!
</Tip>

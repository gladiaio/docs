...
You can check in detail the different transcription status in the [API Reference](/api-reference/)
...
```
http://localhost:3000/v2/transcription?custom_metadata={"internalUserId": "2348739875894375"}
```
or
```
http://localhost:3000/v2/transcription?custom_metadata={"paymentMethod": {"last4Digits": 4576}, "internalUserName": "Spencer"}
```

<Warning>

`custom_metadata` can only contain object, number and string shorter than 500 characters.

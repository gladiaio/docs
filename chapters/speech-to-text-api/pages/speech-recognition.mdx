...
When code switching is enabled, you may provide a list of languages to the model, ensuring the model will only transcribe to one of thes languages.
```json request data
{
  "audio_url": "YOUR_AUDIO_URL",
  "enable_code_switching": true,
...
If you already know the dominant language, you can disable language detection and use the `language` key to specify the language of the speech in your audio file.

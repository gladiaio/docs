...
- **`realtime_processing.custom_vocabulary`: add company-specific terms**  
  Improves recognition of jargon, acronyms, or product names that the model would otherwise mis-transcribe. Note that this is probabilistic; for guaranteed spelling normalization, use [custom spelling](/chapters/audio-intelligence/custom-spelling) instead.

...
Here is a guide on to migrate to V2, so you can start enjoying all the benefits.
...
<Note>Automatic single language behavior is the default in both V1 and V2, so you can just omit those from your configuration.</Note>
...
If you're not interested in new messages and want the simplicity of the V1 API, you can configure what kind of messages you want when calling the [POST /v2/live endpoint](/api-reference/v2/live/init) to initiate the session.

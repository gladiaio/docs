---
title: "Live transcription - Migration guide from V1 to V2"
sidebarTitle: "Live transcription - V1 to V2"
description: "Migrate to the latest version of Gladia's real-time speech-to-text API"
---

---
title: Features
description: "Core features of the Gladia Live STT API"
---
...
If you expect multiple languages to be spoken during the live, enable the code switching option: 
...
Gladia Live API will automatically split them and transcribe them separately.  
...
You can attach metadata to your live transcription session using the `custom_metadata` property.

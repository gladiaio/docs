...
You can now enable enhanced word splitting functionality with the `split_words` parameter. This feature effectively adjusts timing details during text processing, resulting in more word-level translations but can lead to mis-synchronization for lipsync.
...
```json
{
  "realtime_processing": {
    ...
    "translation_config": {
      ...
      "split_words": true  // Enables enhanced word splitting functionality
    }
  }
}
```

...
The **Translation** model generates translations in the targeted languages of your transcriptions and subtitles (if you enabled [subtitles](/chapters/speech-to-text-api/pages/speech-recognition#export-srt-or-vtt-caption-files))
You can translate your transcription to **multiples language** in a single call to the API.
 
The list of the languages covered by the Translation addons are listed in the [API Reference](/api-reference/api-v2/Transcription/post-v2transcription/) (see `translation_config`)

**2 translation models** are availables:

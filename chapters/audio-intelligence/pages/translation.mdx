...
The list of the languages covered by the Translation feature are listed in the [API Reference](/api-reference/v2/transcription/init) (see `translation_config`).

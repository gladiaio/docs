...
The **Translation** model generates translations of your transcriptions to one or more targeted languages. If [subtitles](/chapters/speech-to-text-api/pages/speech-recognition#export-srt-or-vtt-caption-files) and/or [sentences](/chapters/speech-to-text-api/pages/speech-recognition#sentences) are enabled, the translations will also include translated results for them.
You can translate your transcription to **multiples languages** in a single API call.
 
The list of the languages covered by the Translation feature are listed in the [API Reference](/api-reference/api-v2/Transcription/post-v2transcription/) (see `translation_config`).
...
## Usage
To enable content moderation set the `"translation"` parameter to true
```json request data
{

---
title: Moderation
description: "Find out if your transcription needs to be moderated and why"
---
...
The **Moderation** model scans your transcription and finds out if it contains words and expressions that need to be moderated.

...
The **Translation** model generates translations of your transcriptions to one or more targeted languages. If [subtitles](/chapters/audio-intelligence/subtitles) are enabled, the translations will also include translated results for them.
...
<ParamField body="match_original_utterances" type="boolean" default>
  ...
  - When **true**, the system attempts to match the translated segments (utterances) to the timing and structure of the original detected speech segments.

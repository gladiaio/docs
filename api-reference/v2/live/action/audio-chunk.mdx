...
Send raw audio to your live transcription session over WebSocket. You can stream audio either as binary frames or as JSON messages containing a base64-encoded chunk.
...
-   Keep chunks reasonably sized (≃ 100ms) and consecutive for low latency.

...
**Gladia API** aims to provide a complete set of resources alongside with it's **state-of-the-art API** features to makes the integration
as easy as possible, like **webhooks event**,** callback urls**, and **audio intelligence** to transform your transcritpions from raw data to 
